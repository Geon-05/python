...
for i in range(10):
    # 리스트에 추가
    # a.append(i) -> 리스트의 맨 뒤에 항목을 추가
    # a.insert(0, i) -> 리스트의 맨 앞에 항목을 추가
    # a.insert(len(a), i) -> 리스트의 맨 뒤에 항목을 추가
    a.insert(len(a), i)
...
# 리스트를 출력 하면 리스트에 담긴 요소를 확인 할 수 있다
print(f_list)
...
# 리스트에 오렌지가 없으면 3번 인덱스에 오렌지를 리스트에 추가
